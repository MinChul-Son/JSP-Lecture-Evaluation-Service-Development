...
<body>
	...
	<section class="container">
		<form method="get" action="./index.jsp" class="form-inline mt-3">
			...
			<input type="text" name="searc" class="form-control mx-1 mt-2" placeholder="내용을 입력하세요.">
		...
		<div class="card bg-light mt-3">
			<div class="card-header bg-light">
				<div class="row">
					<div class="col-8 text-left">데이터베이스&nbsp;<small>손민철</small></div>
			...
			<div class="card-body">
				<h5 class="card-title">
					개씹레전드 강의.&nbsp;<small>(2019년 2학기)</small>
				</h5>
				<p class="card-text">교수님이 너무 꿀잼에 강의 내용도 좋고 학점도 걍 퍼주네요.</p>
				<div class="row">
					<div class="col-9 text-left">
						성적<span style="color:red;">A</span>
						꿀과목<span style="color:red;">A</span>
		...
		<div class="card bg-light mt-3">
			<div class="card-header bg-light">
				<div class="row">
					<div class="col-8 text-left">노래부르기&nbsp;<small>백예린</small></div>
					<div class="col-4 text-right">
						종합<span style="color: red;">A</span>
					</div>
				</div>
			...
			<div class="card-body">
				<h5 class="card-title">
					힐링되는 강의.&nbsp;<small>(2019년 1학기)</small>
				</h5>
				<p class="card-text">백예린님이 직접 노래부르는 법도 알려주고 진짜 좋은 강의에요.</p>
				<div class="row">
					<div class="col-9 text-left">
						성적<span style="color:red;">A</span>
						꿀과목<span style="color:red;">A</span>
		...
		<div class="card bg-light mt-3">
			<div class="card-header bg-light">
				<div class="row">
					<div class="col-8 text-left">마이크로프로세서&nbsp;<small>홍길동</small></div>
					<div class="col-4 text-right">
			...
			<div class="card-body">
				<h5 class="card-title">
					지루하고 재미없음.&nbsp;<small>(2018년 2학기)</small>
				</h5>
				<p class="card-text">내용이 너무 어렵고 지루해요 절대 듣지마세요.제발</p>
				<div class="row">
					<div class="col-9 text-left">
						성적<span style="color:red;">A</span>
						꿀과목<span style="color:red;">C</span>
	...
	<footer class="bg-dark mt-4 p-5 text-center" style="color: #FFFFFF;">
		Copyright &copy; 2021손민철 All Rights Reserved.
	</footer>
	<!-- 제이쿼리 자바스크립트 추가하기 -->
